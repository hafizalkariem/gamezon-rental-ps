  ...
  return (
    <div className="pt-20 min-h-screen">
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Join exciting gaming events, compete in tournaments, and win amazing
            prizes!
          </p>
        </motion.div>
          ...
          >
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-8 max-w-md mx-auto">
              ...
              <p className="text-gray-400 mb-6">
                Unable to load events. Please check your internet connection.
              </p>
              <button
                onClick={fetchEvents}
            ...
            <div className="absolute top-4 right-4 z-10">
              <span className="px-4 py-2 bg-gradient-to-r from-neon-blue to-neon-purple text-white font-bold rounded-full shadow-lg backdrop-blur-sm">
                ...
                {featuredEvents.length > 1 &&
                  `${currentFeaturedIndex + 1}/${featuredEvents.length}`}
              </span>
            </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-white font-bold">
                            {event.entry_fee === 0
                              ? "Free"
                              : `Rp ${event.entry_fee.toLocaleString()}`}
                          </div>
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div
                      ...
                      } items-center justify-center bg-gradient-to-br from-gray-800 via-gray-700 to-gray-900`}
                    >
                    ...
                    <div className="absolute top-4 right-4">
                      <span
                        className={`px-3 py-1.5 rounded-full text-xs font-bold border backdrop-blur-sm ${getStatusBg(
                          event.status
        ...
        >
          ...
          <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
            Join our community of competitive gamers and start your journey to
            becoming a champion. Register for upcoming tournaments and events!
          </p>
      ...
      <ConfirmModal
        ...
        message={
          confirmModal.event
            ? `Register for ${confirmModal.event.title}?\n\nEntry Fee: ${
                confirmModal.event.entry_fee === 0
                  ? "Free"
                  : `Rp ${confirmModal.event.entry_fee.toLocaleString()}`
              }\nDate: ${new Date(
                confirmModal.event.event_date
